...
//Jan 2009
//
//Modified by Greg Lepley to suit needs
//Sept 2014
//********************************************************
...
{
	//unsigned char row = 0; /* 0-6 */
	//unsigned char col = 0; /* 0-699 */
	//unsigned char mem[8][700];
	//unsigned char j;
	//unsigned char ch;
	//int count = 0;
	//int location = 0;
	...
	//{
		...
		//mem[row][col] = 0x00;
		//for(j=0; j<5; j++)
		//mem[row][col + j] |=  pgm_read_byte(&(smallFont [(ch-32)*5 + j] ));
//
		//mem[row][col + 6] = 0x00;
//
		//
	...
	//{
		//ch = *string++;
		//
		//mem[cusor_row][cursor_col] = 0x00;
		//for(j=0; j<5; j++)
		//mem[cursor_row][cursor_col + j] |=  pgm_read_byte(&(smallFont [(ch-32)*5 + j] ));
//
		//mem[cursor_row][cursor_col + 6] = 0x00;
//
		//
	//}
